class Board:
    ...
    def initialize_board(self):
        match self.game_number:
            case 0: 
                self.quadrants[0][0][0][0] = 0 # Quadrant 0, row 0, column 1, (0=joueur, 1=color)
                self.quadrants[0][0][1][0] = 0
                self.quadrants[0][0][2][0] = 0
                self.quadrants[0][0][3][0] = 0

                self.quadrants[1][0][0][0] = 0
                self.quadrants[1][0][1][0] = 0
                self.quadrants[1][0][2][0] = 0
                self.quadrants[1][0][3][0] = 0

                self.quadrants[2][3][0][0] = 1
                self.quadrants[2][3][1][0] = 1
                self.quadrants[2][3][2][0] = 1
                self.quadrants[2][3][3][0] = 1

                self.quadrants[3][3][0][0] = 1
                self.quadrants[3][3][1][0] = 1
                self.quadrants[3][3][2][0] = 1
                self.quadrants[3][3][3][0] = 1
