...
class BotConfigScreen:
    """
    Classe : interface graphique pour la configuration du mode Bot.
    Permet à l'utilisateur de configurer les paramètres de jeu pour le mode Bot
    et visualiser le plateau de jeu avant de lancer la partie.
    """
    
    def __init__(self, selector):
        """
        Constructeur : initialise l'écran de configuration Bot.
    ...
    def show(self):
        """
        Procédure : affiche l'écran de configuration Bot et gère l'interaction utilisateur.
    ...
    def draw(self):
        ...
        # Titre principal
        title_text = self.title_font.render("Configuration Mode Bot", True, (0, 0, 0))
    ...
    def back_action(self):
        ...
        """
        Logger.info("BotConfig", "Retour à l'écran d'accueil")
    ...
    def open_quadrant_config_page(self):
        ...
        """
        Logger.info("BotConfig", "Ouverture de la page de configuration des quadrants")
        ...
        if updated_quadrants:
            ...
            Logger.info("BotConfig", "Configuration des quadrants mise à jour")
    ...
    def start_game_action(self):
        ...
        if not game_save:
            Logger.warning("BotConfig", "Nom de sauvegarde invalide.")
            return
            
        Logger.info("BotConfig", f"Starting bot game: {selected_game}, name: {game_save}")
        ...
        if self.selector.mode_selection:
            self.selector.mode_selection.selected_index = 1  # Mode Bot
        
        # Mise à jour des quadrants
        self.selector.selected_quadrants = self.selected_quadrants
        
        # Lancement du jeu
        self.game_launcher.start_game(game_save, selected_game, "Bot", self.selected_quadrants)
